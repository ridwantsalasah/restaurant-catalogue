import FavoriteRestaurantSearchPresenter from '../src/scripts/views/pages/liked-restaurant/favorite-restaurant-search.js';
    ...
    describe('When query is not empty', () => {
        ...
        it('should show the restaurants found by Favorite restaurants', (done) => {
            document.getElementById('lists').addEventListener('lists:updated', () => {
                expect(document.querySelectorAll('.restaurants-item').length).toEqual(3);
                done();
            });
